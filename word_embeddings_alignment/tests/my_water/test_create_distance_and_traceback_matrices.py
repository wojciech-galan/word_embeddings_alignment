...
def test_1_linear_gap__distance_matrix(ednafull_simplified: Dict[str, Dict[str, int]], linear_gap__distance_matrix_1: np.ndarray):
	np.testing.assert_array_equal(
...
def test_1_linear_gap__traceback_matrix(ednafull_simplified: Dict[str, Dict[str, int]], linear_gap__traceback_matrix_1: np.ndarray):
	np.testing.assert_array_equal(
...
def test_2_linear_gap__distance_matrix(ednafull_simplified: Dict[str, Dict[str, int]], linear_gap__distance_matrix_2: np.ndarray):
	np.testing.assert_array_equal(
...
def test_2_linear_gap__traceback_matrix(ednafull_simplified: Dict[str, Dict[str, int]], linear_gap__traceback_matrix_2: np.ndarray):
	np.testing.assert_array_equal(
...
def test_3_linear_gap_distance_matrix(ednafull_simplified: Dict[str, Dict[str, int]], linear_gap__distance_matrix_3:np.ndarray):
	np.testing.assert_array_equal(
...
def test_3_linear_gap__traceback_matrix(ednafull_simplified: Dict[str, Dict[str, int]], linear_gap__traceback_matrix_3: np.ndarray):
	np.testing.assert_array_equal(
...
def test_1_affine_gap_distance_matrix(ednafull_simplified: Dict[str, Dict[str, int]], affine_gap__distance_matrix_1: np.ndarray):
	np.testing.assert_array_equal(
...
def test_1_affine_gap__traceback_matrix(ednafull_simplified: Dict[str, Dict[str, int]], affine_gap__traceback_matrix_1: np.ndarray):
	np.testing.assert_array_equal(
